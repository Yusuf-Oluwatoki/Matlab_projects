...
logposterior=@(p) logp(p,matern_vec1,dmat)-(p(1)-0.03)^2/(2*0.05^2)-(p(2)-0.03)^2/(2*0.05^2);
maximum_li=fminsearch(@(p) logp(p,matern_vec1,dmat),[1,1]')
%%
% clc
...
model.ssfun= ssfun; data=matern_vec1; model.N=1;
